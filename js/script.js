const translations = {
    'pt-BR': {
        ...
        modalTitle: '📋 Classificação do Link',
        modalQuestion: 'Deseja classificar este link com categoria e descrição?',
        catInputCustom: 'NOVA CATEGORIA',
        btnEditCategory: '✏️ Editar',
        descInput: 'Breve descrição do link (máx 25)',
        btnModalNo: 'NÃO',
        btnModalYes: 'SIM',
        btnModalSaveFinal: 'SALVAR',
        btnAddItem: 'Adicionar',
        placeholderCat: 'Categoria (Opcional)',
        placeholderDesc: 'Descrição (Opcional)',
        filterAll: 'Todas as Categorias',
        filterNone: 'Sem Categoria',
    ...
    'en-US': {
        ...
        modalTitle: '📋 Link Classification',
        modalQuestion: 'Do you want to classify this link with a category and description?',
        catInputCustom: 'NEW CATEGORY',
        btnEditCategory: '✏️ Edit',
        descInput: 'Brief link description (max 25)',
        btnModalNo: 'NO',
        btnModalYes: 'YES',
        btnModalSaveFinal: 'SAVE',
        btnAddItem: 'Add',
        placeholderCat: 'Category (Optional)',
        placeholderDesc: 'Description (Optional)',
        filterAll: 'All Categories',
        filterNone: 'No Category',
    ...
    'es': {
        ...
        modalTitle: '📋 Clasificación del Enlace',
        modalQuestion: '¿Desea clasificar este enlace con categoría y descripción?',
        catInputCustom: 'NUEVA CATEGORÍA',
        btnEditCategory: '✏️ Editar',
        descInput: 'Breve descripción del enlace (máx 25)',
        btnModalNo: 'NO',
        btnModalYes: 'SÍ',
        btnModalSaveFinal: 'GUARDAR',
        btnAddItem: 'Añadir',
        placeholderCat: 'Categoría (Opcional)',
        placeholderDesc: 'Descripción (Opcional)',
        filterAll: 'Todas las Categorías',
        filterNone: 'Sin Categoría',
